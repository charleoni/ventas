      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
          <div class="form-group">
            <label for="exampleFormControlInput1">Fecha desde</label>
            <input type="date" name="date_desde" id="date_desde" min="2018-01-01" class="form-control">
          </div>
        </div>
        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
          <div class="form-group">
            <label for="exampleFormControlInput1">Fecha hasta</label>
            <input type="date" name="date_hasta" id="date_hasta" max="2018-12-31" class="form-control">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div class="form-group">
            <button id="btgetData" type="button" class="btn btn-primary" onclick="getDataInforme01()"> Consultar </button>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12" id="grafica01" style="width:100%; "></div>
      </div>
      <div class="row">
        <div class="col-12" id="grafica02" style="width:100%; "></div>
      </div>
      <div class="row">
